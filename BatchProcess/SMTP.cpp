...
CSMTPBodyPart& CSMTPBodyPart::operator=(const CSMTPBodyPart& bodyPart)
{
  ...
  for (int i=0; i<bodyPart.m_ChildBodyParts.GetSize(); i++)
  {
...
{ 
  ...
  //Now copy over the new object
  for (int i=0; i<message.m_ToRecipients.GetSize(); i++)
  {
  ...
  for (int i=0; i<m_CCRecipients.GetSize(); i++)
    delete m_CCRecipients.GetAt(i);
  m_CCRecipients.RemoveAll();

  //Now copy over the new object
  for (int i=0; i<message.m_CCRecipients.GetSize(); i++)
  {
  ...
  for (int i=0; i<m_BCCRecipients.GetSize(); i++)
    delete m_BCCRecipients.GetAt(i);
  m_BCCRecipients.RemoveAll();

  //Now copy over the new object
  for (int i=0; i<message.m_BCCRecipients.GetSize(); i++)
  {
